...
OGraphicsEngine::OGraphicsEngine()
{
	...
	auto dummyWindow = CreateWindowEx(NULL, MAKEINTATOM(classId), L"OpenGL 3D Game", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, NULL, NULL);
